...
public class S3ConfigLocal {
    public static final String BUCKET_NAME = "pcs-invoice-seguradora";
    ...
    public void createQueue(AmazonSNS snsClient, String s3InvoiceEventsTopicArn, AmazonSQS sqsClient) {
    ...
    private AmazonS3 getAmazonS3() {
        AWSCredentials credentials = new BasicAWSCredentials("test", "teste");
